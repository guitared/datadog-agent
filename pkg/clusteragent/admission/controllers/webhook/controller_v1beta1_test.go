...
func TestGenerateTemplatesV1beta1(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			autoinstrumentation.UnsetAutoInstrumentationInjectionFilter()       // Ensure that the webhook uses the config set above
			defer autoinstrumentation.UnsetAutoInstrumentationInjectionFilter() // So other tests are not impacted
